...
function drawScoreboard() {
    ...
    if (gameState === 0) {
        ...
        renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 170 * settings.scale, 150, "#2c3e50", "Benzene");
...
function showText(text) {
    var messages = {
        'paused': "<div class='centeredHeader unselectable'>Paused</div><br><div class='unselectable centeredSubHeader'>Press play to resume</div><div style='height:100px;line-height:100px;cursor:pointer;'></div>",
